...
const ContactSection = ({
  title = "Get in Touch",
  subtitle = "Have questions about training or want to book a session? Fill out the form below and Coach Ibra will get back to you soon.",
  address = "123 Fitness Avenue, Nice, France",
  email = "coach@ibrafitness.com",
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg border border-gray-100">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a
                    href={`mailto:${email}`}
                    className="text-blue-700 hover:text-blue-900 hover:underline mt-1 block font-medium"
                  >
                    {email}
                  </a>
                </div>
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                ...
                <a
                  href="#"
                  className="bg-pink-700 text-white p-2 rounded-full hover:bg-pink-800 transition-colors"
                >
                  <svg
                    className="h-5 w-5"
                    fill="currentColor"
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea
                          placeholder="How can Coach Ibra help you?"
