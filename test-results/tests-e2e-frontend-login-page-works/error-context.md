...
- Name: login page works
- Location: C:\projets\coach-ibra\Front-end\tests\e2e\frontend.spec.ts:16:1
...
Call log:
  - navigating to "/login", waiting until "load"
    ...
    at C:\projets\coach-ibra\Front-end\tests\e2e\frontend.spec.ts:17:14
```
