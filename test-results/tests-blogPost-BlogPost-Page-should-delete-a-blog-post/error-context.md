...
- Name: BlogPost Page >> should delete a blog post
- Location: C:\projets\coach-ibra\Front-end\tests\blogPost.spec.ts:31:3
...
Call log:
  - navigating to "/blog-posts", waiting until "load"
    ...
    at C:\projets\coach-ibra\Front-end\tests\blogPost.spec.ts:32:16
```
