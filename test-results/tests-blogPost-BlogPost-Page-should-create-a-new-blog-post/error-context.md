...
- Name: BlogPost Page >> should create a new blog post
- Location: C:\projets\coach-ibra\Front-end\tests\blogPost.spec.ts:10:3
...
Call log:
  - navigating to "/blog-posts", waiting until "load"
    ...
    at C:\projets\coach-ibra\Front-end\tests\blogPost.spec.ts:11:16
```
