...
- Name: BlogPost Page >> should display a list of blog posts
- Location: C:\projets\coach-ibra\Front-end\tests\blogPost.spec.ts:4:3
...
Call log:
  - navigating to "/blog-posts", waiting until "load"
    ...
    at C:\projets\coach-ibra\Front-end\tests\blogPost.spec.ts:5:16
```
